<template>
  <div id="ale-authors" class="box-layout-wrapper" v-if="$store.state.pageCollection && $store.state.pageCollection.length && listReady" :style="optionsOpenMargin" ref="wrapper">
