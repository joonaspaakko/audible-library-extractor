  ...
  methods: {
    ...
    amapxios: function( options ) {
      ...
      asyncMap( options.requests, function( request, stepCallback ) {
        ...
        axios.get( (request.requestUrl || request.url || request), axiosConfig ).then(function( response ) {
          ...
          if ( !e.response ) {
            ...
            options.step( e.response, function(result) { stepCallback(null,result) }, request );
          }
          else {
