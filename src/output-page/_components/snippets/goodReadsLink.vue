<template>
  ...
  v-if="goodreadsUrl" :class="{ 'top-right': topRight }"
  >
    <div 
    v-if="icon" class="gr-icon" content="Search for the book in Goodreads" 
...
.gr-icon {
  ...
  img { display: inline-block; max-width: 60%; height: auto; }
  background: #fff;
  border-radius: 10px;
}
