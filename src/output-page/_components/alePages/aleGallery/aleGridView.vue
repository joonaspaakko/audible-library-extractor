...
@media (max-width: 616px) {
  ...
  .ale-book {
    width: calc( 33.333333333vw - 25px);
    height: calc( 33.333333333vw - 25px);
  }
  .sort-values-on .ale-book {
    height: calc(33.333333333vw - 25px + 27px);
  }
