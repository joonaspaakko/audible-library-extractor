<template>
  <tr class="ale-row-inner">
    ...
    <td v-for="col in columns" :key="col.key" class="ale-col" :class="col.class" :name="col.name">
      ...
      <div class="tippy-content-wrapper" v-if="!tippyLoading">
        ...
        <div class="book-information">
          ...
          <div class="corner-actions">
            <favorite-book   :size="25" :book="book" :general="general"></favorite-book>
            <sampleButton    :size="25" :book="book" :index="rowIndex"></sampleButton>
            <good-reads-link :size="25" :book="book" :general="general" :icon="true"></good-reads-link>
          </div>
    ...
    prepareColumns: function() {
      ...
      return _.map(this.keys, function( key ) {
        ...
        switch ( key ) {
          ...
          case 'series':
          case 'publishers':
            col.text = vue.stringifyArray( vue.book[key], 'name', (key === 'categories' ? ' > ' : null) ) ;
            break;
