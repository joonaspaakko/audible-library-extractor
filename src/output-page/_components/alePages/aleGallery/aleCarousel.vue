...
export default {
  name: 'aleCarousel',
  props: ['gallery', 'general', 'books','type'],
  mixins: [
    makeFullUrl,
    makeCoverUrl,
  ],
	...
	methods: {
		...
		sliderTippyContent: function( book ) {
			const html =
				'<div style="font-weight: normal; text-align: left; padding: 10px; font-size: 1em; line-height: 1.4em">' +
					(book.title 		 ? '<div><h3 style="font-size: 1.3em; font-weight: bold; margin: 0 0 3px 0;">'+ book.title +'</h3>' : '') +
